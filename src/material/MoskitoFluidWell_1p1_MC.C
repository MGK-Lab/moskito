...
#include "MoskitoFluidWell_1p_MC.h"
#include "Function.h"

registerMooseObject("MoskitoApp", MoskitoFluidWell_1p_MC);

template <>
InputParameters
validParams<MoskitoFluidWell_1p_MC>()
{
...
MoskitoFluidWell_1p_MC::MoskitoFluidWell_1p_MC(const InputParameters & parameters)
...
void
MoskitoFluidWell_1p_MC::computeQpProperties()
{
...
Real
MoskitoFluidWell_1p_MC::Conv_coeff()
{
