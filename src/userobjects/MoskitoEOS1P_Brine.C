...
Real
MoskitoEOS1P_Brine::rho_from_p_T(const Real & molality, const Real & pressure, const Real & temperature) const
{
...
void
MoskitoEOS1P_Brine::rho_from_p_T(const Real & molality, const Real & pressure, const Real & temperature,
