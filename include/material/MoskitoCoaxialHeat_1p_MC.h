...
class MoskitoCoaxialHeat_1p_MC;

template <>
InputParameters validParams<MoskitoCoaxialHeat_1p_MC>();

class MoskitoCoaxialHeat_1p_MC : public Material
{
public:
  MoskitoCoaxialHeat_1p_MC(const InputParameters & parameters);
