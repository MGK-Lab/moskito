...
class MoskitoEOS1P_MC;

template <>
InputParameters validParams<MoskitoEOS1P_MC>();

class MoskitoEOS1P_MC : public GeneralUserObject
{
public:
  MoskitoEOS1P_MC(const InputParameters & parameters);
  virtual ~MoskitoEOS1P_MC();
